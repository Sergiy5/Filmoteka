export const modalRefs = {
  movieTitle: modal.querySelector('.modal_title'),
  movieVote: modal.querySelector('.vote'),
  moviePopularity: modal.querySelector('.popularity'),
  movieOriginalTitle: modal.querySelector('.original-title'),
  movieGenres: modal.querySelector('.genre'),
